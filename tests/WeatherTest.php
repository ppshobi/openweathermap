...
class WeatherTest extends TestCase
{
    ...
    {
        $mock = $this->getMockBuilder('Shobi\Weatherapp\Http\Client')->disableOriginalConstructor()->getMock();
    ...
    {
        $mock = $this->getMockBuilder('Shobi\Weatherapp\Http\Client')->disableOriginalConstructor()->getMock();
        $mock->method('get')->willThrowException(new ClientException("Location not present", new Request("get", "http://httpbin.org/get")));
